/**
 * MaxRects Best Short Side Fit (BSSF) sheet nest.
 * Adapted from the well-known free/open 2D bin-packing approach
 * used by many open-source cutlist tools (Panelizer, cutlist-optimizer, etc.).
